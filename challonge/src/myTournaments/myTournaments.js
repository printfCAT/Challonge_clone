    ...
    return (
        ...
        <div className="main-mytournament">
            ...
            <div className="mytournaments-content">
                ...
                <Link to="/Challonge_clone/comingsoon" className="mytournaments-create">Create a Tournament</Link>
                ...
                <div className="commence">
                  <div className="mytournaments-text">
                    ...
                    <Link to="/Challonge_clone/comingsoon" className="mytournaments-create2">Create a Tournament</Link>
                  </div>
